...
namespace Low_Level_Objects_Library {
    ...
    public class Card : IEquatable<Card>, IComparable<Card> {
        ...
        // they are needed so that the Hand class methods Sort and Contains function correctly.
       ...
       // Default constructor: Card is "blank" 
        ...
        // The constructor normally used when you know a card's Suit and FaceValue values.
        public Card(Suit suit, FaceValue faceValue) {
            this.suit = suit;
            this.faceValue = faceValue;
        }

        // The constructor used if the colour of the card is required 
        ...
        // Needed so that the Hand class's Contains method works correctly and to satify the IEquatable interface.
        //
        ...
        // Needed so that the Hand class's Sort method works correctly and to satify the IComparable interface.
